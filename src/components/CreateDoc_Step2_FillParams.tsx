...
export default function CreateDocStep2({ navigate, template }) {
              ...
              <div key={step.number} className="flex items-center flex-1">
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{
                      backgroundColor: step.completed || step.active ? "var(--color-navy)" : "#f3f4f6",
                      color: step.completed || step.active ? "var(--color-gold)" : "#9ca3af",
                    }}
                  >
                  ...
                  <span
                    style={{
                      ...
                      color: step.completed || step.active ? "var(--color-navy)" : "#9ca3af",
                    }}
                  >
                    {step.label}
                  </span>
                ...
                {index < 2 && (
                  <div
                    ...
                    style={{ backgroundColor: step.completed ? "var(--color-navy)" : "#e5e7eb" }}
                  />
                )}
              </div>
            ))}
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="mb-10">
                ...
                >
                  Ingresa los datos necesarios para generar tu documento
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  >
                    RUC / DNI <span style={{ color: "#ef4444" }}>*</span>
                  </label>
                  <input
                    id="input_ruc"
                    type="text"
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      {
                        key: "termination",
                        label: "Cláusula de Terminación Anticipada",
                        desc: "Condiciones para finalizar el contrato",
                      },
                      {
                        key: "arbitration",
                        label: "Cláusula de Arbitraje",
                        desc: "Resolución de conflictos mediante arbitraje",
                      },
                      {
                        key: "warranty",
                        label: "Cláusula de Garantía",
                        desc: "Garantías sobre servicios prestados",
                      },
                    ].map((clause) => (
                      <div
                        key={clause.key}
                        ...
                        style={{
                          borderColor: formData.clauses[clause.key] ? "var(--color-gold)" : "#e5e7eb",
                          backgroundColor: formData.clauses[clause.key] ? "#fefce8" : "white",
                        }}
                        onClick={() => handleClauseToggle(clause.key)}
                      >
                        <input
                          type="checkbox"
                          checked={formData.clauses[clause.key]}
                          onChange={() => handleClauseToggle(clause.key)}
          ...
          <div className="hidden lg:block lg:col-span-1">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <Eye className="w-5 h-5" style={{ color: "var(--color-gold)" }} strokeWidth={2} />
                <h3
                  style={{
                    fontSize: "16px",
                    fontWeight: "600",
              ...
              >
                El documento se generará basado en tu información
              </p>
            </div>
          </div>
        </div>
